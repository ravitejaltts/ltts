...
const HistoryCard = () => {
  return (
    <div className={styles.historyCard}>
      <p className={styles.historyTopText}>Power</p>
      <h3 className={styles.historyMiddleText}>87</h3>
      <p className={styles.historyBottomText}>Watts</p>
    </div>
  );
};
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.header}>
        <p className={styles.headingText}>Source History</p>
      </div>
      ...
      <div className={styles.chargingCardsDiv}>
        <HistoryCard />
        <HistoryCard />
        <HistoryCard />
        <HistoryCard />
