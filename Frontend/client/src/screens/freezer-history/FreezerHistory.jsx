...
const FreezerHistory = () => {
  ...
  useEffect(() => {
    axios
      .put(
        data?.controls?.freezer_current_history?.freezer_full_history?.PRESS
          ?.action?.href || API_ENDPOINT.FREEZER_FULL_HISTORY,
        {
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.header}>
        <p className={styles.headingText}>Freezer History</p>
      </div>
