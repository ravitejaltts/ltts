...
model_definition = {
    ...
    "seriesModel": "sandbox",   # TODO: Confirm with Rick
    ...
    "components": [
        ...
        ThermostatWired(
            instance=1,
            state=ThermostatWiredState(),
            attributes={
                'name': 'Thermostat',
                'description': 'Virtual Thermostat - Wired',
                'type': 'MAIN',
                'options': ['TEST', 'AC-4-WIRE']
            },
            meta={
                'manufacturer': 'Winnebago',
                'model': 'WinnConnect Virtual Thermostat',
                'part': 'WC-TH-VIRTUAL-WIRED'
            }
        ),
        HouseDoorLock(
            instance=1,
...
config_definition = {
    ...
    "electrical_mapping": {
        ...
        "dc": {
            ...
            "29": {
                "description": "AC Fan Low",
                "id": 0x1D,
                "long": "C12.2 AC Fan Low",
                "rvOutputId": 70,
                "short": "AC Fan Low",
                "category": "electrical"
            },
            "30": {
                "description": "AC Fan High",
                "id": 0x1E,
                "long": "C12.3 AC Fan High",
                "rvOutputId": 71,
                "short": "AC Fan High",
                "category": "electrical"
            },
        ...
        'RV1_CONTROLS': {
            ...
            '6-3': {
                'bank': 6,
                'output': 3,
                'Name': 'PSM_PB_IGN_COMBO  signal',
                'Comment': 'C2.5 PSM_PB_IGN_COMBO combined status as received by Sprinter PSM',
                "action": "hal_action_component",
                "category": "vehicle",
