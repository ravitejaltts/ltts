...
scp -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null -P $WGO_PORT -r /home/bruce/SmartRV/iot_service/* $WGO_LOCAL:$TARGET_FOLDER

scp -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null -P $WGO_PORT -r /home/bruce/SmartRV/hmi_tools/* $WGO_LOCAL:/opt/smartrv/hmi_tools
