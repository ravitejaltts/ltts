...
current_temp = driver.find_element(By.CLASS_NAME, "temp_mainTemp__bdVdg")
# print(current_temp)
...
temp_down = driver.find_element(By.CLASS_NAME, "temp_controlButtons__5W8PH")
temp_down.click()
time.sleep(1)
temp_down.click()
...
temp_up = driver.find_element(By.XPATH, "/html/body/div/div/div[2]/div[2]/div[2]/div[2]/div/div[3]/button[2]")
# print(temp_up)
# print(dir(temp_up))
temp_up.click()
temp_up.click()
...
input('ENTER to continue')
arrow = driver.find_element(By.XPATH, '/html/body/div/div/div[3]')
arrow.click()
...
back = driver.find_element(By.XPATH, '/html/body/div/div/div[1]/button')
back.click()
