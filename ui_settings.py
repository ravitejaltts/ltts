                                        ...
                                        'items':[
                                            {
                                               ...
                                               'belowtext': 'When Limit Data Usage is turned on, this network will pause automatic updates and background tasks, such as... . This may be helpful if this network is on a limited data plan.',
                                               'type': 'SIMPLE_ONOFF',
                                                'state': {
                                                    'onoff': 0,
                                                },
                    ...
                    },
                    {
                        ...
                        'data': [
                            ...
                            },
                            {
                                ...
                                'type': 'SETTINGS_LIST_ITEM_NAV',
                                'arrow' : 'true',
                                'name' : 'UiSettingsConnectivityKnownNetworks',
                                'data': [
                                    {
                                        'items':[
                                            {
                                                'data':{},
                                                'title': "Boinees's iPhone Hotspot",
                                                'type': "SETTINGS_LIST_ITEM_NAV",
                                                'value': "" 
                                            },
                                            {
                            ...
                            },
                            {
                                'title': 'Add Network',
                                'type': 'SETTINGS_LIST_ITEM_NAV',
                                'name' : 'UiSettingsConnectivityAddNetworks',
                                'data': [
                                    {
                                        'title': 'SELECT WIFI NETWORK SECURITY TYPE',
                                        ...
                                        'actions': {
                                            'TAP': {
                                                ...
                                                'action': {
                                                    'type': 'PUT',
                                                    'href': f'{BASE_URL}/api/setting/connectiviy/addnetwork',
                                                    'params': {
                                                        '$value': 'int'
                                                    }
                                                }
